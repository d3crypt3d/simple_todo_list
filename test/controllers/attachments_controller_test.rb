...
class AttachmentsControllerTest < ActionController::TestCase
  ...
  test "should create attachment" do
    assert_difference('Attachment.count') do
      post :create, attachment: { data: @attachment.data, filename: @attachment.filename, mime_type: @attachment.mime_type }
    end
  ...
  test "should update attachment" do
    patch :update, id: @attachment, attachment: { data: @attachment.data, filename: @attachment.filename, mime_type: @attachment.mime_type }
    assert_redirected_to attachment_path(assigns(:attachment))
  end
