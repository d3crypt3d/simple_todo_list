...
RSpec.describe API::TasksController do
        ...
        context 'when a wrong format is requested' do
            before do
                make_request :get, :index,
                    project_id: project_task_list, accept: Mime::XML 
            end
    ...
    describe 'GET #show' do
        ...
        context 'when a wrong format is requested' do
            before { make_request :get, :show, id: project_task, accept: Mime::XML } 
    ...
    describe 'POST #create' do
        ...
        context 'when a wrong format is requested' do
            before do
                @count = Task.count
                make_request :post, :create, task: attributes_for(:task),
                                     project_id: proj, accept: Mime::XML
            end
    ...
    describe 'PATCH #update' do
        ...
        context 'with valid attributes' do
            before do
                make_request :patch, :update, id: project_task, task: {content: 'updated'}
            end
        ...
        context 'with invalid attributes' do
            before do
                make_request :patch, :update, id: project_task, task: attributes_for(:invalid_task)
            end
        ...
        context 'when a wrong format is requested' do
            before do
                make_request :patch, :update, id: project_task,
                                 task: {content: 'dont_update_me'}, accept: Mime::XML
            end
